...
function Cabinet() {
        ...
        if (imgHeight <= pageHeight - y) {
          ...
          while (remainingHeight > 0) {
            ...
            croppedCanvas.height = Math.min(
              canvas.height,
              ((pageHeight - y) * canvas.width) / imgWidth
            );
  ...
  return (
    ...
    >
      ...
      {user ? (
        <>
          <h1 className={`${s.name} font-sans text-white mt-[100px]`}>
            {user?.name}
          </h1>
          <p className={`${s.email} font-sans text-white`}>{user?.email}</p>
          <h1 className={`${s.name} font-sans text-white mt-5`}>
            Результаты вашей матрицы
          </h1>
          {matrix && tab != "Совместимость" && (
            <div
              className={`${s.block} flex justify-between items-center w-[60%] mt-[50px]`}
            >
              <div
                className={`${s.karta} chakra-container w-[450px] flex flex-col justify-start items-center`}
              >
                <h1 className="font-sans text-white font-bold mb-4 w-[100%] text-[20px]">
                  Карта здоровья
                </h1>
              ...
              <div
                className={`${s.upper} relative`}
                style={{ transform: "scale(1)", transformOrigin: "center" }}
              >
                <div className={s.matrix} ref={matrixRef}>
                  <img
                    src="/images/matrix.png"
                    className="rounded-[50%] absolute z-0 w-[350px]"
                    alt=""
                  />
                  <h1 className="absolute top-[160px] left-[17px] text-white font-bold">
                    {A}
                  </h1>
                  <h1 className="absolute top-[265px] left-[62px] text-black font-bold">
                    {I}
                  </h1>
                  <h1 className="absolute top-[251px] left-[84px] text-black font-bold text-[8px]">
                    {I1}
                  </h1>
                  <h1 className="absolute top-[237px] left-[101px] text-black font-bold text-[8px]">
                    {I2}
                  </h1>
                  <h1 className="absolute top-[10px] left-[168px] text-white font-bold">
                    {B}
                  </h1>
                  <h1 className="absolute top-[42px] left-[170px] text-white font-medium text-[10px]">
                    {P}
                  </h1>
                  <h1 className="absolute top-[64px] left-[170.5px] text-white font-medium text-[8px]">
                    {K}
                  </h1>
                  <h1 className="absolute top-[110px] left-[170px] text-white font-medium text-[8px]">
                    {T}
                  </h1>
                  <h1 className="absolute top-[94px] left-[244px] text-black font-medium text-[8px]">
                    {G1}
                  </h1>
                  <h1 className="absolute top-[80px] left-[258px] text-black font-medium text-[8px]">
                    {G2}
                  </h1>
                  <h1 className="absolute top-[52px] left-[62px] text-black font-bold">
                    {F}
                  </h1>
                  <h1 className="absolute top-[80px] left-[85px] text-black font-medium text-[10px]">
                    {F1}
                  </h1>
                  <h1 className="absolute top-[94px] left-[101px] text-black font-medium text-[8px]">
                    {F2}
                  </h1>
                  <h1 className="absolute top-[52px] left-[272px] text-black font-bold">
                    {G}
                  </h1>
                  <h1 className="absolute top-[165px] left-[272px] text-white font-medium text-[8px]">
                    {L}
                  </h1>
                  <h1 className="absolute top-[165px] left-[69px] text-white font-medium text-[8px]">
                    {S}
                  </h1>
                  <h1 className="absolute top-[164px] left-[49px] text-white font-medium text-[8px]">
                    {O}
                  </h1>
                  <h1 className="absolute top-[163px] left-[292px] text-black font-medium text-[10px]">
                    {Q}
                  </h1>
                  <h1 className="absolute top-[165px] left-[218px] text-black font-medium text-[10px]">
                    {L1}
                  </h1>
                  <h1 className="absolute top-[165px] left-[198px] text-black font-medium text-[10px]">
                    {L2}
                  </h1>
                  <h1 className="absolute top-[162px] left-[168px] text-black font-medium text-[13px]">
                    {E}
                  </h1>
                  <h1 className="absolute top-[312px] left-[168px] text-white font-medium text-[13px]">
                    {D}
                  </h1>
                  <h1 className="absolute top-[268px] left-[273px] text-black font-medium text-[13px]">
                    {H}
                  </h1>
                  <h1 className="absolute top-[252px] left-[257px] text-black font-medium text-[8px]">
                    {H1}
                  </h1>
                  <h1 className="absolute top-[238px] left-[243px] text-black font-medium text-[8px]">
                    {H2}
                  </h1>
                  <h1 className="absolute top-[212px] left-[218px] text-black font-medium text-[7px]">
                    {R}
                  </h1>
                  <h1 className="absolute top-[233px] left-[208px] text-black font-medium text-[7px]">
                    {R1}
                  </h1>
                  <h1 className="absolute top-[207px] left-[238px] text-black font-medium text-[6px]">
                    {R2}
                  </h1>
                  <h1 className="absolute top-[286px] left-[170px] text-black font-medium text-[10px]">
                    {N}
                  </h1>
                  <h1 className="absolute top-[266px] left-[170px] text-white font-medium text-[8px]">
                    {M}
                  </h1>
                  <h1 className="absolute top-[165px] left-[119px] text-white font-medium text-[7px]">
                    {S}
                  </h1>
                  <h1 className="absolute top-[159px] left-[319px] text-white font-bold">
                    {C}
                  </h1>
                </div>
              </div>
          ...
          {matrix && matrix1 && tab == "Совместимость" && (
            <h2 className="font-sans text-white font-black text-[24px] mt-[30px]">
              Общая матрица
            </h2>
          )}
          ...
          <div className="mt-[108px] w-[90%] max-w-[700px] p-6 bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900 rounded-lg shadow-xl">
            <h2 className="text-2xl font-bold text-white mb-6 text-center">
              Что означают результаты матрицы?
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white mt-2 text-sm leading-relaxed">
                  Символизирует духовное развитие, интуицию и высшие идеалы. Это
                  вершина вашего роста.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white mt-2 text-sm leading-relaxed">
                  Отвечает за интеллект, ясность мышления и осознанность. Это
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white mt-2 text-sm leading-relaxed">
                  Ассоциируется с основой жизни, устойчивостью и безопасностью.
                  Ваше чувство стабильности.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-white mt-2 text-sm leading-relaxed">
                  Олицетворяет творчество, эмоции и чувственное восприятие.
              ...
              <div className="flex flex-col items-center text-center sm:col-span-2">
                ...
                <p className="text-white mt-2 text-sm leading-relaxed">
                  Центр силы, уверенности в себе и личной энергии. Ваш
                  внутренний огонь.
                </p>
              </div>
            </div>
      ...
      <button className={s.output} onClick={generatePDF}>
        Результаты в PDF
      </button>
      <button
        className={s.output}
        ...
        onClick={() => {localStorage.clear("id"); navigate('/')}}
      >
        Выйти
      </button>
    </div>
